    ...
    <>
      ...
      >
        <div className='flex flex-col md:flex-row gap-6 items-start md:items-center h-full'>
          ...
          <div className='w-full md:w-1/3 h-40 md:h-full bg-slate-100 dark:bg-slate-700 rounded-xl overflow-hidden flex-shrink-0 flex items-center justify-center'>
            {videoSource && (
              <video
                muted
                loop
          ...
          <div className='flex-1 flex flex-col justify-between h-full'>
            ...
            {/* View More Arrow */}
            <div className='flex items-center justify-end mt-4 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 transition-colors'>
